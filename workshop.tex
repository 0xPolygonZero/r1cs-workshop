...
\begin{forest}
  ...
  selected/.style={edge=red,draw=red}
  [,selected
    [,
      [,
        [$x_0$],
...
\end{forest}
\end{center}
Now, we will describe a few methods of random access which leverage this mental model.
...
\end{forest}
\end{center}
after which the root node $r$ will hold $x_i$.
